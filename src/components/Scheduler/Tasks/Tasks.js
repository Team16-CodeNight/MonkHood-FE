...
import { HiExternalLink, HiTrash, HiPencilAlt } from "react-icons/hi";
...
const Tasks = () => {
  ...
  return (
    <div
      className={`bg-white px-4 py-5 border-b border-gray-200 sm:px-6 ${styles.container}`}
    >
                ...
                return (
                  <div className="relative flex items-start py-4">
                    <div className="min-w-0 flex-1 text-sm">
                      <label
                        htmlFor="comments"
                        className="font-medium text-gray-700 flex flex-row items-center justify-between"
                      >
                        {task?.title}
                        <HiPencilAlt />
                      </label>
                    ...
                    <div className="ml-3 flex items-center h-5 flex-col">
                      <input
                        ...
                        name="comments"
                        type="checkbox"
                        className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded mb-5"
                      />
                      <button
                        type="button"
                        className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
