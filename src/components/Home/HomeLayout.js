    ...
    return ( <
        ...
        div className = "hidden md:flex md:space-x-10" > {
            navigation.map((item) => ( <
                Link key = { item.name }
                to = { item.src }
                className = "font-medium text-gray-500 hover:text-gray-900" > { item.name } <
                /Link>
            ))
        } <
        /div> <
        ...
        div >
        <
        img src = "monkhood-logo.png"
        alt = "img" / > < title > MonkHood < /title> <
        /div> <
        div className = "-mr-2" >
        <
        ...
        /div> <
        Link to = "#"
        className = "block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-50 hover:bg-gray-1000" >
        Log in
        <
        /Link> <
        /div> <
