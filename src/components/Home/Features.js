...
import { ArchiveIcon,StopIcon, IdentificationIcon } from "@heroicons/react/outline";
    ...
    <div className="py-16 bg-gray-50 overflow-hidden lg:py-24">
      <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        <div className="relative">
          <h2 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">A better way to Work</h2>
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div className="relative">
            <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl">Features of MonkHood</h3>
            <p className="mt-3 text-lg text-gray-500">
               Ability to create, edit, and delete events, appointments, and tasks.
              <p>A calendar scheduler can help you manage your time by allowing you to schedule tasks ,appointments, and view your schedule in a visual format.</p>
